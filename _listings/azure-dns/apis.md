...
- name: Azure DNS API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/dns/master/_listings/azure-dns/subscriptions-subscriptionid-providers-microsoft-network-dnszones-get.md
x-common:
