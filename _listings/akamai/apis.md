...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/dns/master/_listings/akamai/etp-report-v1-configs-configid-dns-activities-aggregate-starttimesec,endtimesec,dimension,filters-get.md
x-common:
- type: x-base
